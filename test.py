...
class SnP500Dataset:
    ...
    def build_vocab(self, input_dir):
        ...
        #     print("root: ", root)
        #     print("stock_name: ", str(root).replace(input_dir, ''))
        #     # for filename in files:
        #     #     print("file_path: ", os.path.join(root, filename))
        #     print("subdirs: ", subdirs)
        #     print("files: ", files)
        #     with open("data/tweet/preprocessed/MRK/2015-06-20", 'r', encoding='utf-8') as f:
        #         print("################## I AM HERE #######################")
        #         for line in f:
        ...
        most_freq_words = sorted(word_freq_dict, key=word_freq_dict.get,
                                 reverse=True)
        # print("most_freq_wordsGlove", most_freq_words)
        ...
        # print("array word2vec", np.array(word2vec).shape)
        ...
        for sd in date_freq_dict:
            if date_freq_dict[sd] == 0:
                tweet_zero_days += 1
            print('How many days we do not have twitts',tweet_zero_days)
        # print('max_news_len', len(max_news_len))
    ...
    def load_stock_names(self):
        ...
        for filename in file_names:
            ...
            print("stock_name_set: ", stock_name_set)
        # print("stock_name_set: ", stock_name_set)
        ...
        # print("twt_stock_name_set: ", twt_stock_name_set)
        # print(len(twt_stock_name_set))
            ...
            with open(filepath, 'r', encoding='utf-8') as f:
                ...
                for l in reversed(list(f)):
                    ...
                    if len(stock_dict[stock_name]) > self.flags.days:
                        ...
                        # print("diff_percentages",diff_percentages)
        ...
        for stock_name in self.stock_dict:
            ...
            for i in range(stock_days):
                ...
                for j in [5, 4, 3, 2, 1]:
                    ...
                    # print("tweet_date 5days: ", tweet_date)

                    stock_key = stock_name + '\t' + str(tweet_date)
                    # print("stock_key after 5 days", stock_key)
                    ...
                    if stock_key in self.date_tweets:
                        ...
                        for w_idxes in tweets:
                            ...
                            # print("ex_1 how many tweets have each row",ex_1)
                            t_lens.append(len(w_idxes))
                            print("t_lens", t_lens)

                        day_lens.append(len(tweets))
                        # print("day_lens", day_lens)
...
if __name__ == '__main__':
    ...
    # sp500_dataset.load_stock_names()
